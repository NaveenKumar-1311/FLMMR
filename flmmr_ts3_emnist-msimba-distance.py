...
for g_epoch in range(global_epochs):
    ...
    print("mean:",mean_dist)
    meandistance.append(mean_dist)
    np.save('flmmr_meandistance-msimba.npy', meandistance)
    ...
    print("tolerance interval-msimba:", mean_dist-2*std_dist, mean_dist+2*std_dist)
    tintervallower.append(mean_dist-2*std_dist)
    tintervalupper.append(mean_dist+2*std_dist)
    np.save('tintervallower-msimba.npy', tintervallower)
    np.save('tintervalupper-msimba.npy', tintervalupper)
    ...
    np.save('gtanclp-ts3-emnist-msimba-distance.npy', GTA)
